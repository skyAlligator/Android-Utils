...
public class AppCollections {
     ...
     *
     * @param list    search multiple item from this list object
     * @param compare object for check whether item need to be filtered or not.
    ...
    /**
     * @param list    search single item from this list object
     * @param compare object for check whether item need to be filtered or not.
    ...
    /**
     * @param list    list search single item from this list object
     * @param compare object for check whether item need to be removed or not.
     * @author Dinesh.BS
     */
     ...
     *
     * @param <Item> Object type to compare
     * @author Dinesh.BS
     */
    public interface Compare<Item> {
         ...
         *
         * @param a current object from the list to compare
